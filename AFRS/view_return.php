...
<h1 class="text-center">View File Return</h1>
...
// Get the ID of the file return to view.
$id = $_GET['id'];
...
// Display the file return information.
echo '<h2>File Name</h2>';
echo $row['file_name'];
echo '<h2>File Type</h2>';
echo $row['file_type'];
echo '<h2>Date Created</h2>';
